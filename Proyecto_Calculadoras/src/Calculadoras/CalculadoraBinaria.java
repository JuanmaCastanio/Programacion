...
public class CalculadoraBinaria {
     ...
     * realiza la operación lógica seleccionada por el usuario y muestra el resultado en decimal y en binario.
     * 
    ...
    /**
     * enteroDecimal
     * convierte el resultado decimal en una cadena binaria.
     * 
    ...
    /**
     * verificarBinario
     * revisa si la cadena introducida es un binario antes de operar con él.
     * 
